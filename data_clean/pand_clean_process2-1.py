...
# %%
chunk_size = 100
chunks = pd.read_csv('/opt/project/KG_Assist_LLM/data/pand/datas/pand_clean_process2.csv',chunksize=chunk_size)
...
for j, chunk in enumerate(chunks):
    ...
    if 109<= j <= 201:
        ...
        data_final.to_csv('/opt/project/KG_Assist_LLM/data/pand/datas/pand_clean_process2-1.csv')
    elif j <= 108:
        continue
    else:
        break
